...
public final class TracerParameters {
    ...
    public final static String ACCESS_TOKEN = "spl.accessToken";
    public final static String CLOCK_SKEW_CORRECTION = "spl.clockSkewCorrection";
    public final static String COMPONENT_NAME = "spl.componentName";
    public final static String COLLECTOR_HOST = "spl.collectorHost";
    public final static String COLLECTOR_PORT = "spl.collectorPort";
    public final static String COLLECTOR_PROTOCOL = "spl.collectorProtocol";
    public final static String DEADLINE_MILLIS = "spl.deadlineMillis";
